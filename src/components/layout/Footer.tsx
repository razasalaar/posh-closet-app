    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <img src={logoFull} alt="Mansa Mussa" className="h-48 w-auto mb-4" />
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <Link to="/collections/men" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors font-body">Men Shirts</Link>
              <Link to="/collections/men" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors font-body">Men Trousers</Link>
              <Link to="/collections/women" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors font-body">Women Lawn</Link>
              <Link to="/collections/women" className="text-sm text-primary-foreground/70 hover:text-primary-foreground transition-colors font-body">Women Suits</Link>
            </nav>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-primary-foreground/70 font-body">
              <span>support@mansamussa.store</span>
              <span>+92 326 2500066</span>
              <span>Faisalabad , Pakistan</span>
            </div>
          </div>
        </div>
        <div className="border-t border-primary-foreground/20 mt-12 pt-8 text-center">
          <p className="text-xs text-primary-foreground/70 font-body mb-3">
            Mansa Mussa is an online clothing store Pakistan customers trust for premium men and women fashion.
          </p>
